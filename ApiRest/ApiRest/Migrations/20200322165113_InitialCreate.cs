    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_ADMON = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    NOMBRE_ADMON = table.Column<string>(nullable: true),
                    APELLIDO_ADMON = table.Column<string>(nullable: true),
                    TELEFONO = table.Column<string>(nullable: true),
                    DIRECCION = table.Column<string>(nullable: true),
                    NICK_NAME = table.Column<string>(nullable: true),
                    PASSWORD_ADMON = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ADMINISTRADOR", x => x.ID_ADMON);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_PRODUCTO = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    CODIGO_PRODUCTO = table.Column<string>(nullable: true),
                    NOMBRE_PRODUCTO = table.Column<string>(nullable: true),
                    DESCRIPCION = table.Column<string>(nullable: true),
                    IMAGEN_PROD = table.Column<string>(nullable: true),
                    CANTIDAD_PRODUCTO = table.Column<int>(nullable: false),
                    PRECIO_UNIDAD = table.Column<decimal>(nullable: false),
                    ID_CATEGORIA = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
